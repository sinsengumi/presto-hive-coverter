...
public class Main {
    ...
    public static void main(String[] args) {
        String prestoSql = "SELECT json_EXTRACT_SCALAR(JSON, '$.timestamp'), LOG_DATE FROM HIVE.HOGE_LOG WHERE LOG_DATE='20180328' AND LOG_HOUR='23' AND LOG_TYPE='type1' ORDER BY JSON_EXTRACT_SCALAR(JSON, '$.timestamp'), LOG_DATE LIMIT 10";
